package com.commerce.app.api.web.v1.order;

import com.commerce.app.api.facade.CheckoutFacade;
import com.commerce.app.api.facade.OrderCancellationFacade;
import com.commerce.app.api.facade.OrderPaymentFacade;
import com.commerce.app.api.web.auth.Authenticated;
import com.commerce.app.api.web.v1.order.request.CheckoutPreviewRequest;
import com.commerce.app.api.web.v1.order.request.CheckoutRequest;
import com.commerce.app.api.web.v1.order.request.DirectOrderRequest;
import com.commerce.app.api.web.v1.order.request.OrderReturnRequest;
import com.commerce.app.api.web.v1.order.response.CheckoutPreviewResponse;
import com.commerce.app.api.web.v1.order.response.CheckoutResponse;
import com.commerce.app.api.web.v1.order.response.DirectOrderResponse;
import com.commerce.app.api.web.v1.order.response.OrderPageResponse;
import com.commerce.app.api.web.v1.order.response.OrderResponse;
import com.commerce.app.api.web.v1.payment.response.PaymentResponse;
