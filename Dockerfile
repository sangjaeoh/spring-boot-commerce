# app-migration·app-api·app-batch 공용 멀티스테이지 빌드. compose의 build.target으로 앱을 고른다.
...
RUN --mount=type=cache,target=/root/.gradle \
    ./gradlew --no-daemon :module-apps:app-migration:bootJar :module-apps:app-api:bootJar :module-apps:app-batch:bootJar
