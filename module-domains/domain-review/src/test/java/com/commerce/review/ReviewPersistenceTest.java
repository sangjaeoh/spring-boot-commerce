...
import com.commerce.review.application.ReviewModifier;
import com.commerce.review.application.ReviewReader;
import com.commerce.review.application.ReviewRemover;
...
@Testcontainers
@Import({ReviewAppender.class, ReviewModifier.class, ReviewRemover.class, ReviewReader.class})
