...
import com.commerce.domain.coupon.PersistenceTestConfig;
import com.commerce.domain.coupon.application.info.DiscountPreviewInfo;
...
import com.commerce.domain.coupon.domain.exception.CouponExpiredException;
import com.commerce.domain.coupon.domain.exception.DuplicateIssuanceException;
import com.commerce.domain.coupon.domain.exception.IssuedCouponNotFoundException;
...
@Testcontainers
@Import({
    DefaultCouponAppender.class,
    DefaultIssuedCouponAppender.class,
    DefaultIssuedCouponReader.class,
    DefaultIssuedCouponModifier.class
})
