package com.commerce.order.application.required;
...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    @Query("""
            ...
            where o.memberId = :memberId
              ...
              and o.status = com.commerce.order.domain.OrderStatus.PAID
              and o.fulfillmentStatus = com.commerce.order.domain.FulfillmentStatus.DELIVERED
            """)
